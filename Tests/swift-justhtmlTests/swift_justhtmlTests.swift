...
@Test func justHTMLInitFromData() async throws {
	...
	let html = "<!DOCTYPE html><html><head><meta charset=\"utf-8\"></head><body><p>Hello from Data</p></body></html>"
...
@Test func doctypeCreation() async throws {
	let doctype = Doctype(name: "html", publicId: "-//W3C//DTD HTML 4.01//EN", systemId: "http://www.w3.org/TR/html4/strict.dtd")
