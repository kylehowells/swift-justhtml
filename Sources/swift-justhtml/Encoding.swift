...
public func normalizeEncodingLabel(_ label: String?) -> String? {
  ...
  if s == "iso-8859-1" || s == "iso8859-1" || s == "latin1" || s == "latin-1" || s == "l1"
    || s == "cp819" || s == "ibm819"
  {
    return "windows-1252"
  }
...
private func normalizeMetaDeclaredEncoding(_ label: Data) -> String? {
  ...
  if enc == "utf-16" || enc == "utf-16le" || enc == "utf-16be" || enc == "utf-32"
    || enc == "utf-32le" || enc == "utf-32be"
  {
    return "utf-8"
  }
...
public func decodeHTML(_ data: Data, transportEncoding: String? = nil) -> (
