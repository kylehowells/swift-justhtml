// HTMLStream.swift - Memory-efficient event-based parsing without building a full tree

import Foundation

// MARK: - StreamEvent

/// Events emitted during HTML streaming
...
/// A sequence that yields HTML parsing events without building a tree
